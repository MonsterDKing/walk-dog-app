...
/// generated route for
/// [_i1.TabsScreen]
class TabsScreen extends _i7.PageRouteInfo<void> {
  const TabsScreen({List<_i7.PageRouteInfo>? children})
      : super(
          TabsScreen.name,
...
/// generated route for
/// [_i3.MomentsScreen]
class MomentsScreen extends _i7.PageRouteInfo<void> {
  const MomentsScreen({List<_i7.PageRouteInfo>? children})
      : super(
          MomentsScreen.name,
          initialChildren: children,
        );
...
class MomentsStoryView extends _i7.PageRouteInfo<void> {
  const MomentsStoryView({List<_i7.PageRouteInfo>? children})
      : super(
...
class SignInScreen extends _i7.PageRouteInfo<void> {
  const SignInScreen({List<_i7.PageRouteInfo>? children})
      : super(
          SignInScreen.name,
          initialChildren: children,
        );
